export function GoogleButton() {
  return (
    <button
      type="button"
      className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-line bg-paper-raised py-2.5 text-[14px] font-medium text-ink transition-colors hover:bg-ink/[0.03]"
    >
